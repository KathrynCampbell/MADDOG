#' Lineage Designation Node Information
#'
...
#' @return Information about the defining nodes of each designated lineage
#' @export
node_info <- function(tree, min.support, alignment, metadata, ancestral) {
