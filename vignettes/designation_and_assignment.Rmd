...
The sunburst function produces a sunburst plot to visualise the hierarchical relationship of the lineages, but cannot be demonstrated here.
...
The lineage_map function produces a world map showing which lineages have been found in each country.
